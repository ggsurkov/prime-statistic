...
export class ApiService {
  ...
  testGetRequest() {
    return this.http.post('http://localhost:3000/test/token', {});
  }

  getSellingList(accessToken: string) {
    return this.http.post('http://localhost:3000/test/selling-list', {accessToken: accessToken})
  }
}
